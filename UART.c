...
//                 switching from PC5,PC4 to PA1,PA0
  SYSCTL_RCGC1_R |= 0x02; // activate clock to UART2
  SYSCTL_RCGC2_R |= 0x04; // activate clock to port D
  UART1_CTL_R &= ~0x01;      // disable UART2
  UART1_IBRD_R = 43; //694 43                  // IBRD = int(80,000,000 / (16 * 115200)) = int(43.402778)
  UART1_FBRD_R = 26;  //28   26               // FBRD = round(0.402778 * 64) = 26
                                        // 8 bit word length (no parity bits, one stop bit, FIFOs)
  UART1_LCRH_R = 0x70;
 
  GPIO_PORTC_AFSEL_R |= 0x30;           // enable alt funct on PD6,PD7
  GPIO_PORTC_DEN_R |= 0x30;             // enable digital I/O on PD6,PD7
                                        // configure PD6,PD7 as UART2
  GPIO_PORTC_PCTL_R = (GPIO_PORTC_PCTL_R&0xFF00FFFF)+0x00220000;
  //GPIO_PORTC_PCTL_R |=1<<4;   //recieve
	//GPIO_PORTC_PCTL_R |=1<<5;   //transmit
	GPIO_PORTC_AMSEL_R &= ~0x30;          // disable analog functionality on PD6,PD7
